...
<html lang="en" dir="ltr">
  ...
  <div class="container">
    ...
    <a href="blogs.php?blog=<?php echo $blog_urls[3] ?>"><img src=<?php echo $blog_imgs[3]?> alt=<?php echo $blog_imgs[3]?>></a></div>
    
    <div class="Blog_link"><span><h3><?php echo $blog_titles[4]?></span></h3>
    <a href="blogs.php?blog=<?php echo $blog_urls[4] ?>"><img src=<?php echo $blog_imgs[4]?> alt=<?php echo $blog_imgs[4]?>></a></div>
